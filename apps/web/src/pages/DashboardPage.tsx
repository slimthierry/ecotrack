...
import { useDashboard, useTrends, useBreakdown, useEcoTips } from '@ecotrack/api-client';
import { CarbonGauge, TrendChart, CategoryBreakdown as CategoryBreakdownChart } from '@ecotrack/ui';
