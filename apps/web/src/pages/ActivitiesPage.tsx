...
import { useActivities, useCreateActivity, useDeleteActivity } from '@ecotrack/api-client';
import { ActivityCard } from '@ecotrack/ui';
import type { ActivityCategory, ActivityCreate } from '@ecotrack/types';
